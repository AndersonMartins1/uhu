...
<script language="JavaScript"> function Login(){ var user = document.getElementById("username").value; var pass = document.getElementById("password").value; if (user=="admin" && pass=="123"){window.location = "https://ugupraha.github.io/ugu/";}else{alert("Username dan password anda salah!"); } }
